...
The Sidecar is intentionally represented in the repository now, but Tauri initialization waits until Block 4 so local capability grants are designed against the Core identity/policy model rather than hard-coded into an early desktop prototype.
